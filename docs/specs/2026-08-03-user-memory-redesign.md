...
> 决策日期：2026-08-03
>
> 最近修订：2026-08-05——明确 Assistant Profile 提示词所有权，并强化按需召回：涉及用户稳定信息或过往事件时必须先检索再否认，但仍不进行每轮隐藏式自动召回
>
...
1. **长期记忆**（默认）：Memory 总开关、助手新增免审批授权、Saved Memory 列表、类型/状态筛选、来源、编辑、置顶、完成、遗忘、历史检索开关与隐私说明；
