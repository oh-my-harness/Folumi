...
const chineseCopy = {
  title: '开始使用 Folumi', subtitle: '准备模型、加入资料，然后开始第一次有来源的问答', steps: ['准备模型', '加入资料', '开始提问'], dismiss: '关闭使用引导', later: '稍后再说', back: '上一步', continue: '继续', done: '完成',
  ...
  knowledge: { title: '加入资料与笔记', description: '资料页保存用于 RAG 检索的外部材料；Notebook 独立保存你创建和管理的笔记。', instructions: ['在资料页创建资料集，导入 PDF、Markdown 或文本作为可追溯来源。', '在 Notebook 中创建或导入 Markdown 笔记，保存自己的理解。', '聊天时按需关联资料集或 Notebook，并保留可追溯引用。'], embeddingReady: '嵌入模型已配置', embeddingMissing: '尚未配置嵌入模型', ready: '已有 {count} 个资料集', empty: '还没有来源', embedding: '嵌入设置', open: '打开资料', openNotebook: '打开笔记' },
...
const englishCopy: typeof chineseCopy = {
  title: 'Get started with Folumi', subtitle: 'Prepare a model, add material, and ask your first grounded question', steps: ['Model', 'Sources', 'Ask'], dismiss: 'Close onboarding', later: 'Maybe later', back: 'Back', continue: 'Continue', done: 'Complete',
  ...
  knowledge: { title: 'Add sources and notes', description: 'Sources stores external material for RAG retrieval; Notebook separately stores the notes you create and manage.', instructions: ['Create a source collection and import PDF, Markdown, or text as traceable sources.', 'Create or import Markdown notes in Notebook for your own understanding.', 'Associate a source collection or Notebook with chat as needed and keep citations traceable.'], embeddingReady: 'Embedding configured', embeddingMissing: 'No embedding configured', ready: '{count} source collection(s)', empty: 'No sources yet', embedding: 'Embedding settings', open: 'Open Sources', openNotebook: 'Open Notebook' },
  start: { title: 'Ask your first question', description: 'No tutor or workflow selection is required. Describe the task directly; Chat can search and verify sources when needed.', example: 'For example: “Summarize the three key conclusions in my project material and cite where each one came from.”', action: 'Ask Assistant' },
}
